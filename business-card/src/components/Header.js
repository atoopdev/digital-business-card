...
export default function Header(){
    return <header className="header">
        ...
        <div className="button-box">
            <button className="btn email-btn"><img src={EmailIcon} alt="envelope icon" className="email-icon"></img>Email</button>
            <button className="btn linkedin-btn"><img src={LinkedinLogo} className="linkedin-icon white-filter" alt="LinkedIn Logo"></img>LinkedIn</button>
        </div>
    </header>
}